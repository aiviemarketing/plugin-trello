...
namespace MauticPlugin\AivieTrelloBundle\Integration\Support;
...
use MauticPlugin\AivieTrelloBundle\Form\ConfigAuthType;
use MauticPlugin\AivieTrelloBundle\Integration\AivieTrelloIntegration;

class ConfigSupport extends AivieTrelloIntegration implements ConfigFormInterface, ConfigFormAuthInterface, ConfigFormNotesInterface
{
